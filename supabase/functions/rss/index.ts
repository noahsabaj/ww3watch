...
//
// ?major=1 once narrowed it to stories a classifier judged a significant
// event. The site no longer labels stories that way, so the parameter is
// ignored and old subscriptions get the whole feed.
//
