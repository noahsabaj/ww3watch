...
{#if stories.length > 0}
  <div class="border-b border-gray-800 bg-[#0a0a0b]">
    <div class="max-w-3xl mx-auto">
      <button
        onclick={() => open = !open}
        class="flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-gray-600 hover:text-gray-400 transition-colors pt-3 pb-2 w-full text-left px-4"
      >
