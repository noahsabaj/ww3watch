...
export const FEEDS: Feed[] = [
  ...
  { name: 'NYT World',          url: 'https://rss.nytimes.com/services/xml/rss/nyt/World.xml',                  region: 'US/Western', lang: 'en' },
  ...
  { name: 'Newsweek',           url: 'https://www.newsweek.com/rss',                                            region: 'US/Western', lang: 'en' },
  { name: 'Axios World',        url: 'https://api.axios.com/feed/topics/world',                                  region: 'US/Western', lang: 'en' },
  { name: 'Politico',           url: 'https://rss.politico.com/politics-news.xml',                              region: 'US/Western', lang: 'en' },
  { name: 'The Hill',           url: 'https://thehill.com/feed/',                                                region: 'US/Western', lang: 'en' },
  { name: 'The Atlantic',       url: 'https://www.theatlantic.com/feed/all/',                                   region: 'US/Western', lang: 'en' },
  ...
  { name: 'Stars and Stripes',  url: 'https://www.stripes.com/arc/outboundfeeds/rss/?outputType=xml',           region: 'US/Western', lang: 'en' },
  { name: 'Task & Purpose',     url: 'https://taskandpurpose.com/feed/',                                         region: 'US/Western', lang: 'en' },
  { name: 'Defense One',        url: 'https://www.defenseone.com/rss/all/',                                     region: 'US/Western', lang: 'en' },
  { name: 'Breaking Defense',   url: 'https://breakingdefense.com/feed/',                                       region: 'US/Western', lang: 'en' },
  { name: 'Defense News',       url: 'https://www.defensenews.com/arc/outboundfeeds/rss/',                      region: 'US/Western', lang: 'en' },

  // ── UK ───────────────────────────────────────────────────────────
  { name: 'BBC World',          url: 'https://feeds.bbci.co.uk/news/world/middle_east/rss.xml',                region: 'UK', lang: 'en' },
  { name: 'BBC World News',     url: 'https://feeds.bbci.co.uk/news/world/rss.xml',                            region: 'UK', lang: 'en' },
  { name: 'The Guardian',       url: 'https://www.theguardian.com/world/middleeast/rss',                        region: 'UK', lang: 'en' },
  { name: 'Guardian World',     url: 'https://www.theguardian.com/world/rss',                                   region: 'UK', lang: 'en' },
  { name: 'Sky News',           url: 'https://feeds.skynews.com/feeds/rss/middle-east.xml',                     region: 'UK', lang: 'en' },
  { name: 'Sky News World',     url: 'https://feeds.skynews.com/feeds/rss/world.xml',                           region: 'UK', lang: 'en' },
  ...
  { name: 'Financial Times',    url: 'https://www.ft.com/world?format=rss',                                     region: 'UK', lang: 'en' },
  { name: 'The Telegraph',      url: 'https://www.telegraph.co.uk/rss.xml',                                     region: 'UK', lang: 'en' },
  { name: 'The Spectator',      url: 'https://www.spectator.co.uk/feed/',                                       region: 'UK', lang: 'en' },
  { name: 'Channel 4 News',     url: 'https://www.channel4.com/news/feed/atom',                                 region: 'UK', lang: 'en' },

  // ── EUROPEAN ─────────────────────────────────────────────────────
  { name: 'Deutsche Welle',     url: 'https://rss.dw.com/rdf/rss-en-middle-east',                              region: 'European', lang: 'en' },
  { name: 'DW World',           url: 'https://rss.dw.com/rdf/rss-en-all',                                      region: 'European', lang: 'en' },
  { name: 'France 24',          url: 'https://www.france24.com/en/middle-east/rss',                            region: 'European', lang: 'en' },
  { name: 'France 24 World',    url: 'https://www.france24.com/en/rss',                                         region: 'European', lang: 'en' },
  ...
  { name: 'Politico Europe',    url: 'https://www.politico.eu/feed/',                                           region: 'European', lang: 'en' },
  { name: 'EUobserver',         url: 'https://euobserver.com/feed',                                             region: 'European', lang: 'en' },
  { name: 'El Pais English',    url: 'https://feeds.elpais.com/mrss-s/pages/ep/site/english.elpais.com/portada',region: 'European', lang: 'en' },
  { name: 'Le Monde Diplo',     url: 'https://mondediplo.com/feed/full',                                        region: 'European', lang: 'en' },
  { name: 'Norwegian NRK',      url: 'https://www.nrk.no/toppsaker.rss',                                        region: 'European', lang: 'no' },
  { name: 'SVT Nyheter',        url: 'https://www.svt.se/nyheter/rss.xml',                                      region: 'European', lang: 'sv' },
  ...
  { name: 'Sputnik World',      url: 'https://sputniknews.com/export/rss2/world/index.xml',                     region: 'Russian', lang: 'en' },
  { name: 'RIA Novosti',        url: 'https://ria.ru/export/rss2/world/index.xml',                              region: 'Russian', lang: 'ru' },
  ...
  { name: 'Novaya Gazeta Europe', url: 'https://novayagazeta.eu/feed',                                          region: 'Russian', lang: 'en' },
  { name: 'iStories',           url: 'https://istories.media/feed/',                                            region: 'Russian', lang: 'ru' },
  { name: 'Radio Svoboda',      url: 'https://www.svoboda.org/api/ztrqtqpym/rss.xml',                          region: 'Russian', lang: 'ru' },
  ...
  { name: 'People\'s Daily',    url: 'http://en.people.cn/rss/politics.xml',                                    region: 'Chinese', lang: 'en' },
  { name: 'Taiwan News',        url: 'https://www.taiwannews.com.tw/feed/news',                                 region: 'Chinese', lang: 'en' },
  { name: 'Taipei Times',       url: 'https://www.taipeitimes.com/xml/index.rss',                               region: 'Chinese', lang: 'en' },
  { name: 'Focus Taiwan',       url: 'https://focustaiwan.tw/rss',                                              region: 'Chinese', lang: 'en' },
  ...
  { name: 'ARY News',           url: 'https://arynews.tv/feed/',                                                region: 'South Asian', lang: 'en' },
  { name: 'Samaa TV',           url: 'https://www.samaa.tv/feed/',                                              region: 'South Asian', lang: 'en' },
  ...
  { name: 'Hindustan Times',    url: 'https://www.hindustantimes.com/feeds/rss/world/rssfeed.xml',              region: 'South Asian', lang: 'en' },
  { name: 'NDTV',               url: 'https://feeds.feedburner.com/ndtvnews-world-news',                        region: 'South Asian', lang: 'en' },
  { name: 'India Today',        url: 'https://www.indiatoday.in/rss/1206578',                                   region: 'South Asian', lang: 'en' },
  { name: 'The Wire',           url: 'https://thewire.in/feed',                                                 region: 'South Asian', lang: 'en' },
  { name: 'The Print',          url: 'https://theprint.in/feed/',                                               region: 'South Asian', lang: 'en' },
  { name: 'Daily Star BD',      url: 'https://www.thedailystar.net/feed/rss.xml',                               region: 'South Asian', lang: 'en' },

  // ── EAST ASIAN ───────────────────────────────────────────────────
  { name: 'NHK World',          url: 'https://www3.nhk.or.jp/nhkworld/en/news/feeds/rss.xml',                  region: 'East Asian', lang: 'en' },
  { name: 'Japan Times',        url: 'https://www.japantimes.co.jp/feed/',                                      region: 'East Asian', lang: 'en' },
  { name: 'Nikkei Asia',        url: 'https://asia.nikkei.com/rss/feed/nar',                                    region: 'East Asian', lang: 'en' },
  { name: 'Yonhap',             url: 'https://en.yna.co.kr/RSS/news.xml',                                       region: 'East Asian', lang: 'en' },
  { name: 'Korea Herald',       url: 'https://www.koreaherald.com/rss/world.xml',                               region: 'East Asian', lang: 'en' },
  { name: 'Korea Times',        url: 'https://www.koreatimes.co.kr/www/rss/rss.xml',                            region: 'East Asian', lang: 'en' },
  { name: 'Straits Times',      url: 'https://www.straitstimes.com/news/asia/rss.xml',                          region: 'East Asian', lang: 'en' },
  { name: 'Channel News Asia',  url: 'https://www.channelnewsasia.com/api/v1/rss-outbound-feed?_format=xml',   region: 'East Asian', lang: 'en' },

  // ── AFRICAN ───────────────────────────────────────────────────────
  { name: 'Africanews',         url: 'https://www.africanews.com/feed/rss',                                     region: 'African', lang: 'en' },
  { name: 'AllAfrica',          url: 'https://allafrica.com/export/rss2/en/africa.xml',                        region: 'African', lang: 'en' },
  { name: 'Premium Times',      url: 'https://www.premiumtimesng.com/feed',                                     region: 'African', lang: 'en' },
  { name: 'The East African',   url: 'https://www.theeastafrican.co.ke/tea/rss',                                region: 'African', lang: 'en' },
  { name: 'Daily Nation Kenya', url: 'https://nation.africa/rss.xml',                                           region: 'African', lang: 'en' },
  { name: 'Mail & Guardian',    url: 'https://mg.co.za/feed/',                                                  region: 'African', lang: 'en' },
  ...
  { name: 'SABA Yemen Agency',  url: 'https://saba.ye/en/showrss',                                             region: 'Arab/Gulf', lang: 'en' },
  { name: 'Yemen Monitor',      url: 'https://www.yemenmonitor.com/feed/',                                      region: 'Arab/Gulf', lang: 'en' },
  { name: 'Libya Observer',     url: 'https://www.libyaobserver.ly/feed',                                       region: 'Arab/Gulf', lang: 'en' },
  { name: 'Egypt Independent',  url: 'https://egyptindependent.com/feed/',                                      region: 'Arab/Gulf', lang: 'en' },
  { name: 'Al-Arabiya Arabic',  url: 'https://www.alarabiya.net/ar/rss.xml',                                    region: 'Arab/Gulf', lang: 'ar' },
  { name: 'Xinhua Middle East', url: 'https://english.news.cn/middleeast/rss.xml',                              region: 'Arab/Gulf', lang: 'en' },
  { name: 'Global Voices MENA', url: 'https://globalvoices.org/regions/middle-east-north-africa/feed/',         region: 'Arab/Gulf', lang: 'en' },
  ...
  { name: 'ISW',                url: 'http://iswresearch.blogspot.com/feeds/posts/default',                     region: 'Independent/OSINT', lang: 'en' },
  { name: 'The Defense Post',   url: 'https://thedefensepost.com/feed/',                                        region: 'Independent/OSINT', lang: 'en' },
  { name: 'Brookings',          url: 'https://www.brookings.edu/feed/',                                         region: 'Independent/OSINT', lang: 'en' },
  { name: 'Carnegie Endowment', url: 'https://carnegieendowment.org/feed/',                                     region: 'Independent/OSINT', lang: 'en' },
  { name: 'Global Voices',      url: 'https://globalvoices.org/feed/',                                          region: 'Independent/OSINT', lang: 'en' },
  { name: 'The Conversation',   url: 'https://theconversation.com/global/articles.atom',                        region: 'Independent/OSINT', lang: 'en' },
  { name: 'Just Security',      url: 'https://www.justsecurity.org/feed/',                                      region: 'Independent/OSINT', lang: 'en' },
  { name: 'ACLED',              url: 'https://acleddata.com/feed/',                                             region: 'Independent/OSINT', lang: 'en' },
]
