...
- **Signal homepage** — one story, full screen, swipe for the next theater. Original headlines, a publisher photograph when the newsroom attached one (otherwise a colour field — never a generated image), other newsrooms underneath, tap through to the in-app reader. List is one tap away.
